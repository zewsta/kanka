...
async def fetch_image(url: str) -> Image.Image | None:
    """Fetches an image from the given URL, resizes it if necessary for JioSaavn and YouTube thumbnails,
    and returns the loaded image as a PIL Image object, or None on failure.
